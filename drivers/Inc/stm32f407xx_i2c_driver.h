...
typedef struct
{
	...
	uint8_t I2C_DeviceAddress;  //will be mentioned by the user
...
#define SPI_FLAG_RXNE   								( 1 << I2C_SR1_RXNE)
...
uint8_t I2C_MasterSendDataIT(I2C_Handle_t *pI2C_Handle_t, uint8_t *pTxBuffer, uint32_t Len, uint8_t SlaveAddr, uint8_t Sr);
uint8_t I2C_MasterReceiveDataIT(I2C_Handle_t *pI2C_Handle_t, uint8_t *pRxBuffer, uint32_t Len, uint8_t SlaveAddr, uint8_t Sr);
...
void I2C_ER_IRQHandling(I2C_Handle_t *pI2C_Handle_t);
 ...
 */
void I2C_ApplicationEventCallback(I2C_Handle_t *pI2CHandle,uint8_t AppEv);  //this should be implemented by the application
